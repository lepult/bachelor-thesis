...
% Kleiner Personenkrei der befragt wird (normalerweise 5 Personen oder bei verschiedenen Nutzerkreisen 3-4 pro Nutzerkreis) [https://www.nngroup.com/articles/how-many-test-users/]
% Zwei Nutzergruppen: Nutzer die mit chayns vertraut sind und Nutzer die nicht/wenig mit chayns vertraut sind
    % 6-8 Testpersonen
% nur Testpersonen die den Prototyp noch nicht gesehen haben
% Normalerweise sind Mitarbeiter nicht geeignet [https://www.nngroup.com/articles/employees-user-test/] in diesem Fall aber schon
    % Weil Mitarbeiter bereits mit chayns vertraut sind
    % Weil Anwendung zum Teil auch für Mitarbeiter gemacht ist
% Fragenkatalog Beispiele
    % Fragen zu einer Aktivität erst breit und dann genauer (wenn z.B. gefragtes Element nicht gefunden wird) [https://www.nngroup.com/articles/user-testing-stepped-tasks/]
% Thinking Aloud durch Nutzer [https://www.nngroup.com/articles/thinking-aloud-the-1-usability-tool/]
% Folgefrage Beispiel
