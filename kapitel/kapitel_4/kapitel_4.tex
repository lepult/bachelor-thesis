...
\begin{figure}[H]
    \centering
    \caption[]{Test}\label{fig:RobotStatusUpdate}
    \includegraphics[width=0.9\textwidth]{Websocket Service 2.png}
\end{figure}
