...
Diese Dateigröße beeinflusst die Ladezeit beim Herunterladen der Daten vom Webserver und auch beim Rendern der 3D-Modelle negativ. Aus diesem Grund müssen die Dateien komprimiert werden. In Kontext dieser Arbeit wird hierfür OptimizeGLB eingesetzt. Das Werkzeug basiert auf gltf-transform. Insbesondere durch den Einsatz des WebP Bildformats für Texturen werden Dateien effektiv komprimiert. 
% gltf-transform
% OptimizeGLB Quelle
So sind die komprimierten Dateien 330 und 550 KB groß was einer Kompression von über 90\% entspricht.
% Genauer auf die genaue Kompression eingehen. Vllt Tabelle und/oder Schaubild erstellen.
Die Qualität der komprimierten 3D-Modelle ist erkennbar geringer, reicht für den Zweck des Prototyp aber trotzdem aus, da größere Merkmale weiter erkennbar sind und somit die Übersichtlichkeit weiter garantiert wird.
